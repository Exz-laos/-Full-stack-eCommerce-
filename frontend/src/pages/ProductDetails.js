    ...
    <div className='container mx-auto p-4'>
        <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
              ...
              <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
                ...
                {
                 zoomImage && (
                   <div className='hidden lg:block absolute min-w-[500px] overflow-hidden 
                        min-h-[400px] bg-slate-200 p-1 -right-[510px] top-0'>
                    <div
                    ...
                    loading ? (
                      <div className='grid gap-1 w-full'>
                         <p className='bg-slate-200 animate-pulse h-6 lg:h-8 w-full 
                          rounded-full inline-block'></p>
                         <p className='h-6 lg:h-8 bg-slate-200 animate-pulse w-full'></p>
                      ...
                      <div className='flex items-center gap-2 font-medium my-1 h-6 lg:h-8  
                      ...
                      <div className='w-full'>
                        <p className=' font-medium my-1 h-6 lg:h-8 bg-slate-200 rounded 
                           animate-pulse w-full'> </p>
