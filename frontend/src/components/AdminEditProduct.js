...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (response.ok && responseData.success) {
      ...
      Swal.fire({
        title: 'ລົ້ມເຫຼວ!',
        text: responseData.message || "ການອັບເດດສິນຄ້າແມ່ນລົ້ມເຫຼວ.",
        icon: 'error',
    ...
    Swal.fire({
      title: 'ຜິດພາດ!',
      text: "ມີຂໍ້ຜິດພາດໃນການອັບເດດສິນຄ້າ",
      icon: 'error',
      timer: 2000, // Auto-close after 2 seconds
      showConfirmButton: false // Hide the confirm button
    });
  ...
  return (
    <div className='lao-text fixed w-full h-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center '>
      <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
        <div className='flex justify-between items-center pb-3'>
          <h2 className='font-bold text-lg'>ແກ້ໄຂຂໍ້ມູນສິນຄ້າ</h2>
